	...
	$schemes = [
		...
		'condensed' => [
			...
			'primary' => [
				...
				'stack'   => "'Roboto Condensed', 'Oswald', Impact, 'Franklin Gothic', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'",
				'var'     => true,
				'size'    => '2rem',
				'weight'  => '700',
				'min'     => '300',
		...
		'slab' => [
			...
			'primary' => [
				'family'  => 'Slaab',
				'stack'   => "'Slaab', 'Rokkitt', 'Roboto Slab', 'Hoefler Text', Garamond, serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'",
				'var'     => false,
				'size'    => '2rem',
				'weight'  => '800',
				'min'     => '100',
...
function define_font_scheme() {
	...
	$style  = "\n" . '<style id="font-scheme-props">:host, :root {';
